...
/**
 * Title: Header Media
 * Slug: nutofito/header-media
 * Categories: nutofito, header
 */
?>
			...
			<div class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile is-vertically-aligned-center">
				<div class="wp-block-media-text__content"><!-- wp:group {"layout":{"type":"constrained","contentSize":"600px","justifyContent":"left"}} -->
					<div class="wp-block-group"><!-- wp:paragraph {"align":"left","style":{"typography":{"textTransform":"capitalize","fontStyle":"normal","fontWeight":"400","letterSpacing":"0px"},"spacing":{"margin":{"bottom":"7px"}}},"fontSize":"upper-heading"} -->
						<p class="has-text-align-left has-upper-heading-font-size" style="margin-bottom:7px;font-style:normal;font-weight:400;letter-spacing:0px;text-transform:capitalize"><?php esc_html_e('Your Personal', 'nutofito'); ?></p>
						<!-- /wp:paragraph -->

						<!-- wp:heading {"textAlign":"left","style":{"spacing":{"margin":{"bottom":"0","top":"0px"}},"typography":{"lineHeight":1.3}},"fontSize":"huge"} -->
						<h2 class="wp-block-heading has-text-align-left has-huge-font-size" style="margin-top:0px;margin-bottom:0;line-height:1.3"><?php esc_html_e('Nutritionist', 'nutofito'); ?></h2>
						<!-- /wp:heading -->
						...
						<p class="has-text-align-left is-style-default has-gray-color has-text-color" style="margin-top:28px;letter-spacing:2.1px"><?php esc_html_e('Vestibulum velit nulla, feugiat et vehicula sed, dictum quis erat. Nullam non feugiat risus.', 'nutofito'); ?></p>
						<!-- /wp:paragraph -->
						...
						<div class="wp-block-buttons" style="margin-top:21px"><!-- wp:button -->
							<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php esc_html_e('View Plans', 'nutofito'); ?></a></div>
							<!-- /wp:button -->
						</div>
						<!-- /wp:buttons -->
					</div>
