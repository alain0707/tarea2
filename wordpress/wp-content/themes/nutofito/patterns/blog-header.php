			...
			<div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"inherit":true,"type":"constrained"}} -->
				<div class="wp-block-group"><!-- wp:group {"className":"alignwide"} -->
					<div class="wp-block-group alignwide"><!-- wp:heading {"textAlign":"center","level":1,"className":"wp-block-post-title","fontSize":"post-heading"} -->
						<h1 class="wp-block-heading has-text-align-center wp-block-post-title has-post-heading-font-size"><?php esc_html_e('From The Blog', 'nutofito'); ?></h1>
						<!-- /wp:heading -->
					</div>
					<!-- /wp:group -->
				</div>
