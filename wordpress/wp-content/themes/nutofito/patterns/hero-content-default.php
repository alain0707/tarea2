<?php
  ...
  * Slug: nutofito/hero-content-default
  * Categories: nutofito
  */
?>
...
<p class="has-primary-color has-text-color"><?php echo esc_html__( 'About Us', 'nutofito' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"fontSize":"large"} -->
<h2 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'Nutrition for Special Diet', 'nutofito' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'We solve business problems,take a consultative approach to every client engagement, and find actionable solutions that will help your organization achieve the best business outcomes', 'nutofito' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'READ MORE', 'nutofito' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/resource/images/call-two.png" alt="" class="wp-image-294" style="width:38px;height:38px" width="38" height="38"/></figure>
<!-- /wp:image -->

<!-- wp:paragraph {"style":{"typography":{"fontSize":"1.4rem"}},"textColor":"foreground"} -->
<p class="has-foreground-color has-text-color" style="font-size:1.4rem"><?php echo esc_html__( '+111 22 33 456', 'nutofito' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
