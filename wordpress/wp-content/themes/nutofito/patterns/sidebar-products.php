<?php
  ...
  * Slug: nutofito/sidebar-products
...
<div class="wp-block-group wp-block-widget-area wp-block-sidebar">
	...
	<div class="wp-block-group wp-block-widget">
		...
		<h2 id="search-products" style="margin-top: 0px; margin-right: 0px; margin-bottom: 20px; margin-left: 0px;"><?php esc_html_e ( 'Search Products', 'nutofito' ); ?></h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-group wp-block-widget">
		<!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}}} -->
		<h2 id="categories" style="margin-top: 0px; margin-right: 0px; margin-bottom: 20px; margin-left: 0px;"><?php esc_html_e ( 'Categories', 'nutofito' ); ?></h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-group wp-block-widget">
		...
		<div class="wp-block-woocommerce-filter-wrapper">
			<!-- wp:heading {"level":3} -->
			<h3><?php esc_html_e ( 'Filter by price', 'nutofito' ); ?></h3>
			<!-- /wp:heading -->
	...
	<div class="wp-block-group wp-block-widget wp-filter-by-size">
		...
		<div class="wp-block-woocommerce-filter-wrapper">
			<!-- wp:heading {"level":3} -->
			<h3><?php esc_html_e ( 'Filter by size', 'nutofito' ); ?></h3>
			<!-- /wp:heading -->
	...
	<div class="wp-block-group wp-block-widget wp-filter-by-color">
		...
		<div class="wp-block-woocommerce-filter-wrapper">
			<!-- wp:heading {"level":3} -->
			<h3><?php esc_html_e ( 'Filter by Color', 'nutofito' ); ?></h3>
			<!-- /wp:heading -->
